...
const persons=RelationsUtility.readFile("./persons3.txt");
...
assert.strictEqual(relationsUtility.FindMinRelationLevel(mosheDayan,vladimirPutin),7);
//test the same relationship again
assert.strictEqual(relationsUtility.FindMinRelationLevel(mosheDayan,vladimirPutin),7);
assert.strictEqual(relationsUtility.FindMinRelationLevel(person1,person2),-1);
